  ...
  const handleExportPng = () => {
    ...
    image.onload = () => {
      ...
      if (context) {
        ...
        downloadLink.download = 'repository-blueprint.png';
    ...
    <div className="w-full h-full bg-slate-950 rounded-3xl overflow-hidden shadow-2xl shadow-black/30 border border-white/5 relative group">
      ...
      <div className="absolute top-4 right-4 z-20 flex items-center gap-2">
        <button
          ...
          className="px-3 py-1.5 bg-violet-600/90 hover:bg-violet-500 text-white rounded-xl text-xs font-mono font-bold flex items-center gap-2 shadow-lg backdrop-blur-md border border-white/10 transition-all hover:scale-105"
          title="Export Architecture View to PNG"
        >
          <Download className="w-3.5 h-3.5" /> Export to PNG
        </button>
      </div>
